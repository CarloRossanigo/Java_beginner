...
public class Esercizio4{
    public static class Cmp implements Comparator <Evento>{
	@Override
	...
	public static void main(String args[]){
	    ...
	    myAgenda.add(e21);
	    System.out.println("# # # # # # # EVENTI ORDINATI(NUOVO ORDINE) # # # # # # # ");
	    List<Evento> eventi=myAgenda.eventi();
	    Agenda.sort(eventi,new Cmp());
	    for(Evento ev: eventi)
		System.out.println(ev);
	    System.out.println("# # # # # # # EVENTI SPECIALI ORDINATI(NUOVO ORDINE) # # # # # # # ");
	    List<EventoSpeciale> eventiSpeciali=myAgenda.eventiSpeciali();
	    Agenda.sort(eventiSpeciali,new Cmp());
	    for(Evento ev: eventiSpeciali)
		System.out.println(ev);
